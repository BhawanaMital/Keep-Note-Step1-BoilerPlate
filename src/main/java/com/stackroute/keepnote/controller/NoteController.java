...
public class NoteController {
	...
	@RequestMapping("/")
	public String getAllNodes(ModelMap modelMap){
...
//	public String saveNote(ModelMap model ,@RequestParam("noteId") Integer noteId,
...
//
//		for (Note note: noteRepository.getList()) {
...
//
	...
	public String saveNote(ModelMap modelMap, @RequestParam Integer noteId,@RequestParam String noteTitle,@RequestParam String noteContent,@RequestParam String noteStatus){
		Note newDetails=new Note();
		newDetails.setNoteId(noteId);
		newDetails.setNoteTitle(noteTitle);
		newDetails.setNoteContent(noteContent);
		...
		for (Note note:noteRepository.getList()){
			System.out.println(note.getNoteId() + " " + note.getNoteTitle() + " " + note.getNoteContent() + " " + note.getNoteStatus());
	 ...
	 * of the NoteRepository classbjbj
